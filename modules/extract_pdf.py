...
if __name__ == '__main__':
    pdf_loc = "/Users/macbookc23551/projects/seres-ai-sercive/src/test/resources/latex.pdf";
    ...
    images = load_pdf_fitz(pdf_loc, dpi=300)
    for idx, img in enumerate(images):
        img.save(f"_{idx}.jpg")

    # img.save(os.path.join("data/input", pdf_loc.replace(".pdf", f"_.jpg")))
